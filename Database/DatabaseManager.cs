...
public class DatabaseManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        itemList.Add(new Item(20301, "사파이어 반지", "1분에 마나 1을 회복시켜주는 마법 반지", Item.ItemType.Equip, 0, 0, 1));
        ...
        itemList.Add(new Item(30003, "고대 유물", "고대 유적에 잠들었던 고대의 유물", Item.ItemType.Quest));
    }
