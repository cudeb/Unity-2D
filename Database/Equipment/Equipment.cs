...
public class Equipment : MonoBehaviour
{
    ...
    private const int WEAPON = 0, SHILED = 1, AMULET = 2, LEFT_RING = 3, RIGHT_RING = 4, HELMET = 5, ARMOR = 6, 
        LEFT_GLOVE = 7, RIGHT_GLOVE = 8, BELT = 9, LEFT_BOOTS = 10, RIGHT_BOOTS = 11;
    ...
    IEnumerator OOCCoroutine(string _up, string _down)
    {
        ...
        if (theOOC.GetResult())
        {
            ...
            ShowTxT();
            equipItemList[selectedSlot] = new Item(0, "", "", Item.ItemType.Use,0,0,0,0,0);
